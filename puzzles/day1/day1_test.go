...
func TestPart1(t *testing.T) {
	...
	answer, err := day1Part1(&list1, &list2)
	if err != nil {
...
func TestParse(t *testing.T) {
	...
	listOne, listTwo, err := day1Parse(&inputPath)
	if err != nil {
